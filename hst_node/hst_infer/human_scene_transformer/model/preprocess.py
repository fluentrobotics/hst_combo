...
class PreprocessLayer(tf.keras.layers.Layer):
  ...
  def call(self,
    ...
    input_batch = self._add_original_and_target(input_batch)  # Set target to 0. where NaN
    input_batch = self._add_has_data(input_batch)   # has data and historics data
  ...
  def _add_has_data(self, input_batch):
    ...
    # [b, a, 1, 1]  has full historic data for inference
